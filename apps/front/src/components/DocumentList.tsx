        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">
              Manage your company documents securely
            </p>
          </div>
        ...
        {documents.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 mb-6">
              Upload your first document to get started with your data room
            </p>
          </div>
        ) : (
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-800">
                  All documents are encrypted and stored securely. Only you and
                  authorized investors can access these files.
                </p>
              </div>
            </div>
          </div>
